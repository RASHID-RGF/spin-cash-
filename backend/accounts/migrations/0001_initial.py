...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('spin_reward', 'Spin Reward'), ('video_reward', 'Video Reward'), ('quiz_reward', 'Quiz Reward'), ('referral_bonus', 'Referral Bonus'), ('withdrawal', 'Withdrawal'), ('deposit', 'Deposit')], max_length=20)),
